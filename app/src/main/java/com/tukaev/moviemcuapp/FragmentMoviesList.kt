...
import com.tukaev.moviemcuapp.databinding.FragmentMoviesListBinding
...
class FragmentMoviesList : Fragment() {
    ...
    override fun onCreateView(
        ...
        val moviesList = binding.moviesRecycleView
        val movies = generateMovies()
        val adapter = MoviesListAdapter(movies)
        moviesList.adapter = adapter
        moviesList.layoutManager = GridLayoutManager(MainActivity(), 2)

        binding.rootList.setOnClickListener {
